...
Система поддерживает **профили GPU** для разных конфигураций железа.

### Профили (см. [PROFILES.md](PROFILES.md))
...
python -m tools.generator.main --profile rtx4070ti-max --theme "Пещера"
```
...
- `rtx2080ti-balanced` - RTX 2080 Ti сбалансированный
- `rtx2080ti-max` - RTX 2080 Ti максимум
- `rtx2080ti-light` - RTX 2080 Ti быстрый
- `low-vram` - Для GPU < 8GB VRAM
- `cpu-only` - CPU-only режим (очень медленно)
...
| refiner | qwen2.5:14b | 0.3 | Финальная полировка |
